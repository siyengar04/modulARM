...
bool positionControlMode = true; // true = position, false = speed
float targetPosition = 0.0;      // degrees
float targetSpeed = 0.0;         // degrees/second
unsigned long lastPIDTime = 0;
unsigned long pidInterval = 10; // PID calculation every 10ms
